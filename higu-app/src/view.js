...
import { load_sync, load_async } from './utils';
 ...
 */
var public_SelectionProvider = function()
 ...
 */
var public_SingleProvider = function( obj_id )
    ...
    {
        var display = displib.make_object_display( this.obj_id );
 ...
 */
var public_SearchProvider = function( query )
    ...
    public_SearchProvider.prototype.fetch = function( idx )
    {
        ...
        this.index = idx;
        var display = displib.make_object_display( response.object_id );
        return display;
    };
 ...
 * class ListProvider
 */
var public_ListProvider = function( list )
