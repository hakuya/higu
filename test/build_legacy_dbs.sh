...
DB_14_1_COMMIT=schema-14.1
DB_14_1_PYTHON=python3
ALL_VERSIONS="$ALL_VERSIONS 14.1"

DB_15_0_COMMIT=schema-15.0
DB_15_0_PYTHON=python3
ALL_VERSIONS="$ALL_VERSIONS 15.0"

DB_16_0_COMMIT=$(git -C $HIGU_DIR rev-parse HEAD)
DB_16_0_PYTHON=python3
ALL_VERSIONS="$ALL_VERSIONS 16.0"
